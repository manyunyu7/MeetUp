 ...
 * Use the [active_booking.newInstance] factory method to
 * create an instance of this fragment.
 */
class user_active_booking : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment active_booking.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            user_active_booking().apply {
